...
export const loadCandidates = async (contract) => {
...
export const checkVoterStatus = async (contract, address) => {
  const [voted, candidateId] = await contract.getVoterVote(address);
